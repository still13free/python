...
class NaNInListError(Exception):
    msg = f"You've tried to enter NaN"


input_list = list()
while True:
    try:
        enter = input("Enter number or string or 'stop': ")
        if enter == 'stop':
            print(input_list)
            break
        elif enter.isdigit():
            input_list.append(int(enter))
            continue
        else:
            raise NaNInListError
    except NaNInListError as err:
        print(err.msg)
